...
public class PanelControl extends JPanel {
    public PanelControl(){
        ...
        BPExamination mybp = new BPExamination(LocalDate.now(), 130,70, "ST");
        MRIExamination mymri = new MRIExamination(LocalDate.now(), "https://martinh.netfirms.com/BIOE60010/mri1.jpg", 2);
        ...
        BPExamination mybp2 = new BPExamination(LocalDate.now(), 150, 80, "VST");
        MRIExamination mymri2 = new MRIExamination(LocalDate.now(), "https://martinh.netfirms.com/BIOE60010/mri2.jpg", 4);
